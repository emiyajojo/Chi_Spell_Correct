...
class Args:
    ...
    def initialize(parser: argparse.ArgumentParser):
        ...
        parser.add_argument('--train_data', default='../data/raw_data/train.json', help='train data for model')
        parser.add_argument('--valid_data', default='../data/raw_data/dev.json', help='valid data for model')
        parser.add_argument('--test_data', default='../data/raw_data/dev.json', help='test data for model')
        ...
        parser.add_argument('--other_lr', default=2e-3, type=float, help='lr for the other module')
